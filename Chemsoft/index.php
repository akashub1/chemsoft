...
<div class="w3-top">
  <div class="w3-bar w3-white w3-padding w3-card" style="letter-spacing:4px;">
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <form class="w3-container" action="check.php" method="POST">
      ...
      <form class="w3-container" action="register.php" method="POST">
        <div class="w3-section">
         <h5>Name</h5>
          ...
          <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="Enter Email" name="username" id="username" onkeyup="checkemail(); " required>
            <h5>Phone</h5>
